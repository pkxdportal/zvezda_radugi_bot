...
async def launch_game(app: Application, chat_id: int):
    ...
    intro = (
        "💀🌑 *Тьма… или Сладость?* 🍬👁️‍🗨️\n\n"
        "Хе-хе-хе... добро пожаловать, жалкие души… Я — *Звезда Ужаса* 🌈😈\n"
        "Пять проклятых дверей ждут вас… каждая — шаг в бездну.\n"
        "Ответьте реплаем: сладость 🍬 или... гадость 💀\n"
        f"⏱️ У вас есть лишь {fmt_duration(ROUND_SECONDS)}… пока не поздно.\n\n"
        "Смелые... постучите в первую дверь... если осмелитесь 🚪👻"
    )
