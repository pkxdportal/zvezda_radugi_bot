...
async def end_round(context: ContextTypes.DEFAULT_TYPE):
    ...
    # кто вылетел ИМЕННО в этом раунде:
    # считаем только тех, кто был жив и ответил в этом раунде
    if r == 1:
    ...
    # Итог без Markdown (во избежание ошибок парсинга из-за символов в никнеймах)
    result = (
